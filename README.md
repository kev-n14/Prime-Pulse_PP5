...
<img src="https://res.cloudinary.com/dlulkctls/image/upload/v1689572938/readme-primepulse/paypal_transaction_vum32d.png" alt="Paypal Transaction Page" width="800"/>
...
1. Step 1: Navigate to the signup page via the navigation bar. Click on the Sign-Up button
...
3. Step 3: The user will be greeted by a message and asked to check their emails to verify the account.
...
5. Step 5: The user will then have access to their dashboard.
...
1. Step 1: Navigate to the search bar located on the navbar at the top of the page
...
1. Step 1: From the dashboard, users can access their order history by clicking on the 'My Orders' button
...
1. Step 1: Users can do this by navigating to the sign-in page via the navigation bar. Once here they will be prompted to enter their credentials to log in.
...
1. Step 1: Once the user has logged in and added items to their car. If they click on the cart button from here they can review the cart.
...
2. Step 2: By clicking on the checkout button the user is brought to the "Place Order" page. Here they are prompted to fill out the 'Billing Address' form.
...
2. Step 2: From here users can fill out the two required fields to reset their password.
...
2. Step 2: From here, the user can click on the profile picture field and 'choose file' button
...
2. Step 2: From here, the user can provide an email to sign up for the newsletter
